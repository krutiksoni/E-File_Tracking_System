...
<head>
  <meta charset="utf-8" />
  <title>File Tracking System | Profile</title>
  ...
  <div id="content" class="app-content box-shadow-z2 bg pjax-container" role="main">
    <div class="app-header white bg b-b">
          <div class="navbar" data-pjax>
                ...
                <div class="navbar-item pull-left h5" id="pageTitle">Admin Profile</div>
                <!-- navbar right -->
    ...
    <div class="container">
        <div class="profile">
            <?php
                ...
                $q = "SELECT user_name, user_id, email, mobile, role FROM `user` WHERE privilege = 1";
                $result = mysqli_query($con, $q);
                $row = mysqli_fetch_array($result);
            ?>
