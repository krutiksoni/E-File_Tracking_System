...
<div class="padding">
  ...
  <form method="post" enctype="multipart/form-data">
      ...
      // Add this code after the existing form processing code...
      ...
      if (isset($_FILES['file'])) {
        ...
        if ($fileError === UPLOAD_ERR_OK) {
          // Specify the destination directory and file path
          $destination = 'uploads/' . $fileName; // Change 'uploads/' to your desired directory
